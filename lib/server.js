...
var PAGE_DONE_CHECK_TIMEOUT = process.env.PAGE_DONE_CHECK_TIMEOUT || 300 *30;

var RESOURCE_DOWNLOAD_TIMEOUT = process.env.RESOURCE_DOWNLOAD_TIMEOUT || 10 * 1000 *3;

var WAIT_AFTER_LAST_REQUEST = process.env.WAIT_AFTER_LAST_REQUEST || 500*3;

var JS_CHECK_TIMEOUT = process.env.JS_CHECK_TIMEOUT || 300*3;

var JS_TIMEOUT = process.env.JS_TIMEOUT || 10 * 1000 *3;

var NO_JS_EXECUTION_TIMEOUT = process.env.NO_JS_EXECUTION_TIMEOUT || 3000;

var EVALUATE_JAVASCRIPT_CHECK_TIMEOUT = process.env.EVALUATE_JAVASCRIPT_CHECK_TIMEOUT || 300*3;

var NUM_ITERATIONS = process.env.NUM_ITERATIONS || 40*3;

var NUM_SOFT_ITERATIONS = process.env.NUM_SOFT_ITERATIONS || 30*3;
